...
import com.theabhikdatta.curewell.backend.payload.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //custom cureWell api exception handler
    @ExceptionHandler(CureWellApiException.class)
    public ResponseEntity<ErrorDetail> handleCureWellApiException(CureWellApiException ex,
                                                                  WebRequest request){
        ErrorDetail errorDetail = new ErrorDetail(
                new Date(),
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorDetail> handleCureWellApiException(Exception ex,
                                                                  WebRequest request){
        ErrorDetail errorDetail = new ErrorDetail(
                new Date(),
                ex.getMessage(),
